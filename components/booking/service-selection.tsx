...
const serviceCategories = [
  {
    ...
    services: [
      "Root Touch Up (Short Hair) – 90 mins",
      "Hair Pack (Short Hair) – 90 mins",
      "Hair Pack (Medium Hair) – 90 mins",
      "Hair Pack (Long Hair) – 60 mins",
  ...
  },
  {
    ...
    services: [
      ...
      "Nail Art (Basic, min 4 nails) – 30 mins",
      "Nail Art (Intermediate, min 4 nails) – 40 mins",
      "Nail Art (Advanced, min 4 nails) – 60 mins",
